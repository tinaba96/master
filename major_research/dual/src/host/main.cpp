...
int main(int argc, char **argv)
{
	...
	for(int ep=0; ep < epochs; ++ep)
	{
		...
		//{
			...
			OCL_CHECK(err, cl::Buffer wxf(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxf, src_wxf.data(), &err));
			OCL_CHECK(err, cl::Buffer wxg(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxg, src_wxg.data(), &err));
			OCL_CHECK(err, cl::Buffer wxi(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxi, src_wxi.data(), &err));
			OCL_CHECK(err, cl::Buffer wxo(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxo, src_wxo.data(), &err));
			OCL_CHECK(err, cl::Buffer whf(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_whf, src_whf.data(), &err));
			OCL_CHECK(err, cl::Buffer whg(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_whg, src_whg.data(), &err));
			OCL_CHECK(err, cl::Buffer whi(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_whi, src_whi.data(), &err));
			OCL_CHECK(err, cl::Buffer who(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_who, src_who.data(), &err));

			OCL_CHECK(err, cl::Buffer wxf2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxf2, src_wxf2.data(), &err));
			OCL_CHECK(err, cl::Buffer wxg2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxg2, src_wxg2.data(), &err));
			OCL_CHECK(err, cl::Buffer wxi2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxi2, src_wxi2.data(), &err));
			OCL_CHECK(err, cl::Buffer wxo2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_wxo2, src_wxo2.data(), &err));
			OCL_CHECK(err, cl::Buffer whf2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_whf2, src_whf2.data(), &err));
			OCL_CHECK(err, cl::Buffer whg2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_whg2, src_whg2.data(), &err));
			OCL_CHECK(err, cl::Buffer whi2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_whi2, src_whi2.data(), &err));
			OCL_CHECK(err, cl::Buffer who2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_who2, src_who2.data(), &err));

			OCL_CHECK(err, cl::Buffer bf(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bf, src_bf.data(), &err));
			OCL_CHECK(err, cl::Buffer bg(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bg, src_bg.data(), &err));
			OCL_CHECK(err, cl::Buffer bi(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bi, src_bi.data(), &err));
			OCL_CHECK(err, cl::Buffer bo(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bo, src_bo.data(), &err));

			OCL_CHECK(err, cl::Buffer bf2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bf2, src_bf2.data(), &err));
			OCL_CHECK(err, cl::Buffer bg2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bg2, src_bg2.data(), &err));
			OCL_CHECK(err, cl::Buffer bi2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bi2, src_bi2.data(), &err));
			OCL_CHECK(err, cl::Buffer bo2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_bo2, src_bo2.data(), &err));

			OCL_CHECK(err, cl::Buffer h_wxf(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxf, src_h_wxf.data(), &err));
			OCL_CHECK(err, cl::Buffer h_wxg(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxg, src_h_wxg.data(), &err));
			OCL_CHECK(err, cl::Buffer h_wxi(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxi, src_h_wxi.data(), &err));
			OCL_CHECK(err, cl::Buffer h_wxo(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxo, src_h_wxo.data(), &err));
			OCL_CHECK(err, cl::Buffer h_whf(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_whf, src_h_whf.data(), &err));
			OCL_CHECK(err, cl::Buffer h_whg(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_whg, src_h_whg.data(), &err));
			OCL_CHECK(err, cl::Buffer h_whi(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_whi, src_h_whi.data(), &err));
			OCL_CHECK(err, cl::Buffer h_who(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_who, src_h_who.data(), &err));

			OCL_CHECK(err, cl::Buffer h_wxf2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxf2, src_h_wxf2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_wxg2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxg2, src_h_wxg2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_wxi2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxi2, src_h_wxi2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_wxo2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_wxo2, src_h_wxo2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_whf2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_whf2, src_h_whf2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_whg2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_whg2, src_h_whg2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_whi2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_whi2, src_h_whi2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_who2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_who2, src_h_who2.data(), &err));

			OCL_CHECK(err, cl::Buffer h_bf(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bf, src_h_bf.data(), &err));
			OCL_CHECK(err, cl::Buffer h_bg(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bg, src_h_bg.data(), &err));
			OCL_CHECK(err, cl::Buffer h_bi(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bi, src_h_bi.data(), &err));
			OCL_CHECK(err, cl::Buffer h_bo(contexts[0], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bo, src_h_bo.data(), &err));

			OCL_CHECK(err, cl::Buffer h_bf2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bf2, src_h_bf2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_bg2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bg2, src_h_bg2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_bi2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bi2, src_h_bi2.data(), &err));
			OCL_CHECK(err, cl::Buffer h_bo2(contexts[1], CL_MEM_USE_HOST_PTR | CL_MEM_READ_WRITE, size_bytes_h_bo2, src_h_bo2.data(), &err));
			...
			*/
			...
			OCL_CHECK(err, err = kerneldl[0].setArg(5, wxf));
			OCL_CHECK(err, err = kerneldl[0].setArg(6, wxg));
			OCL_CHECK(err, err = kerneldl[0].setArg(7, wxi));
			OCL_CHECK(err, err = kerneldl[0].setArg(8, wxo));
			OCL_CHECK(err, err = kerneldl[0].setArg(9, whf));
			OCL_CHECK(err, err = kerneldl[0].setArg(10, whg));
			OCL_CHECK(err, err = kerneldl[0].setArg(11, whi));
			OCL_CHECK(err, err = kerneldl[0].setArg(12, who));

			OCL_CHECK(err, err = kerneldl[0].setArg(13, bf));
			OCL_CHECK(err, err = kerneldl[0].setArg(14, bg));
			OCL_CHECK(err, err = kerneldl[0].setArg(15, bi));
			OCL_CHECK(err, err = kerneldl[0].setArg(16, bo));

			OCL_CHECK(err, err = kerneldl[0].setArg(17, h_wxf));
			OCL_CHECK(err, err = kerneldl[0].setArg(18, h_wxg));
			OCL_CHECK(err, err = kerneldl[0].setArg(19, h_wxi));
			OCL_CHECK(err, err = kerneldl[0].setArg(20, h_wxo));
			OCL_CHECK(err, err = kerneldl[0].setArg(21, h_whf));
			OCL_CHECK(err, err = kerneldl[0].setArg(22, h_whg));
			OCL_CHECK(err, err = kerneldl[0].setArg(23, h_whi));
			OCL_CHECK(err, err = kerneldl[0].setArg(24, h_who));

			OCL_CHECK(err, err = kerneldl[0].setArg(25, h_bf));
			OCL_CHECK(err, err = kerneldl[0].setArg(26, h_bg));
			OCL_CHECK(err, err = kerneldl[0].setArg(27, h_bi));
			OCL_CHECK(err, err = kerneldl[0].setArg(28, h_bo));





			OCL_CHECK(err, err = kerneldl[1].setArg(5, wxf2));
			OCL_CHECK(err, err = kerneldl[1].setArg(6, wxg2));
			OCL_CHECK(err, err = kerneldl[1].setArg(7, wxi2));
			OCL_CHECK(err, err = kerneldl[1].setArg(8, wxo2));
			OCL_CHECK(err, err = kerneldl[1].setArg(9, whf2));
			OCL_CHECK(err, err = kerneldl[1].setArg(10, whg2));
			OCL_CHECK(err, err = kerneldl[1].setArg(11, whi2));
			OCL_CHECK(err, err = kerneldl[1].setArg(12, who2));

			OCL_CHECK(err, err = kerneldl[1].setArg(13, bf2));
			OCL_CHECK(err, err = kerneldl[1].setArg(14, bg2));
			OCL_CHECK(err, err = kerneldl[1].setArg(15, bi2));
			OCL_CHECK(err, err = kerneldl[1].setArg(16, bo2));

			OCL_CHECK(err, err = kerneldl[1].setArg(17, h_wxf2));
			OCL_CHECK(err, err = kerneldl[1].setArg(18, h_wxg2));
			OCL_CHECK(err, err = kerneldl[1].setArg(19, h_wxi2));
			OCL_CHECK(err, err = kerneldl[1].setArg(20, h_wxo2));
			OCL_CHECK(err, err = kerneldl[1].setArg(21, h_whf2));
			OCL_CHECK(err, err = kerneldl[1].setArg(22, h_whg2));
			OCL_CHECK(err, err = kerneldl[1].setArg(23, h_whi2));
			OCL_CHECK(err, err = kerneldl[1].setArg(24, h_who2));

			OCL_CHECK(err, err = kerneldl[1].setArg(25, h_bf2));
			OCL_CHECK(err, err = kerneldl[1].setArg(26, h_bg2));
			OCL_CHECK(err, err = kerneldl[1].setArg(27, h_bi2));
			OCL_CHECK(err, err = kerneldl[1].setArg(28, h_bo2));
			...
			OCL_CHECK(err, err = kerneldl[0].setArg(29, 3));
			OCL_CHECK(err, err = kerneldl[1].setArg(29, 3));

			if(count==1)
			{
				OCL_CHECK(err, err = kerneldl[0].setArg(29, 1));
				OCL_CHECK(err, err = kerneldl[1].setArg(29, 1));
			}
			if(count%100==0)
			{
				OCL_CHECK(err, err = kerneldl[0].setArg(29, 100));
				OCL_CHECK(err, err = kerneldl[1].setArg(29, 100));
			}
			if(count==500)
			{
				OCL_CHECK(err, err = kerneldl[0].setArg(29, 500));
				OCL_CHECK(err, err = kerneldl[1].setArg(29, 500));
			}
			...
			OCL_CHECK(err, err = kerneldl[0].setArg(4, 1));
			OCL_CHECK(err, err = kerneldl[1].setArg(4, 3));
			...
			if(count == 1)
			{
				...
				OCL_CHECK(err, err = q_forward[0].enqueueMigrateMemObjects({buffer_datax[0], wxf, wxg, wxi, wxo, whf, whg, whi, who, bf, bg, bi, bo, h_wxf, h_wxg, h_wxi, h_wxo, h_whf, h_whg, h_whi, h_who, h_bf, h_bg, h_bi, h_bo}, 0 ));
				OCL_CHECK(err, err = q_forward[1].enqueueMigrateMemObjects({buffer_datax[1], wxf2, wxg2, wxi2, wxo2, whf2, whg2, whi2, who2, bf2, bg2, bi2, bo2, h_wxf2, h_wxg2, h_wxi2, h_wxo2, h_whf2, h_whg2, h_whi2, h_who2, h_bf2, h_bg2, h_bi2, h_bo2}, 0 ));

			}else{

				OCL_CHECK(err, err = q_forward[0].enqueueMigrateMemObjects({buffer_datax[0]}, 0 ));
				OCL_CHECK(err, err = q_forward[1].enqueueMigrateMemObjects({buffer_datax[1]}, 0 ));

			}

                        //boot the kernel
                        //OCL_CHECK(err, err = q_forward[0].enqueueTask(kerneldl[0]));
                        OCL_CHECK(err, err = q_forward[0].enqueueTask(kerneldl[0], NULL, &events[0]));
                        OCL_CHECK(err, err = q_forward[1].enqueueTask(kerneldl[1], NULL, &events[1]));


                        //receive the data from kernel
                        OCL_CHECK(err, err = q_forward[0].enqueueMigrateMemObjects({buffer_datay[0]}, CL_MIGRATE_MEM_OBJECT_HOST));
                        OCL_CHECK(err, err = q_forward[1].enqueueMigrateMemObjects({buffer_datay[1]}, CL_MIGRATE_MEM_OBJECT_HOST));
			...
			*l = 0;
			...
			clock_t start2 = clock();
                        ...
                        OCL_CHECK(err, err = kerneldl[0].setArg(4, 2));
                        OCL_CHECK(err, err = kerneldl[1].setArg(4, 4));
			...
			//OCL_CHECK(err, cl::CommandQueue q_backward(context, device, CL_QUEUE_PROFILING_ENABLE, &err));
                        ...
                        //transfer activation data from system memmory over PCIe to the FPGA on-board DDR memory
                        OCL_CHECK(err, err = q_backward[0].enqueueMigrateMemObjects({buffer_dout[0]}, 0 ));
                        OCL_CHECK(err, err = q_backward[1].enqueueMigrateMemObjects({buffer_dout[1]}, 0 ));



                        //boot the kernel
                        OCL_CHECK(err, err = q_backward[0].enqueueTask(kerneldl[0], NULL, &events[0]));
                        OCL_CHECK(err, err = q_backward[1].enqueueTask(kerneldl[1], NULL, &events[1]));


			if(count==500)
			{
				//std::cout << "checking in host #5" << std::endl;
				OCL_CHECK(err, err = q_backward[0].enqueueMigrateMemObjects({buffer_result[0], wxf, wxg, wxi, wxo, whf, whg, whi, who, bf, bg, bi, bo, h_wxf, h_wxg, h_wxi, h_wxo, h_whf, h_whg, h_whi, h_who, h_bf, h_bg, h_bi, h_bo}, CL_MIGRATE_MEM_OBJECT_HOST));
				OCL_CHECK(err, err = q_backward[1].enqueueMigrateMemObjects({buffer_result[1], wxf2, wxg2, wxi2, wxo2, whf2, whg2, whi2, who2, bf2, bg2, bi2, bo2, h_wxf2, h_wxg2, h_wxi2, h_wxo2, h_whf2, h_whg2, h_whi2, h_who2, h_bf2, h_bg2, h_bi2, h_bo2}, CL_MIGRATE_MEM_OBJECT_HOST));
			}else{
				OCL_CHECK(err, err = q_backward[0].enqueueMigrateMemObjects({buffer_result[0]}, CL_MIGRATE_MEM_OBJECT_HOST));
				OCL_CHECK(err, err = q_backward[1].enqueueMigrateMemObjects({buffer_result[1]}, CL_MIGRATE_MEM_OBJECT_HOST));

...
public: 
	...
	*/
	...
	void predictf(ap_fixed<16, 4, AP_RND, AP_SAT> *x, ap_fixed<16, 4, AP_RND, AP_SAT> *y, ap_fixed<16, 4, AP_RND, AP_SAT> *wxf, ap_fixed<16, 4, AP_RND, AP_SAT> *wxg, ap_fixed<16, 4, AP_RND, AP_SAT> *wxi, ap_fixed<16, 4, AP_RND, AP_SAT> *wxo, ap_fixed<16, 4, AP_RND, AP_SAT> *whf, ap_fixed<16, 4, AP_RND, AP_SAT> *whg, ap_fixed<16, 4, AP_RND, AP_SAT> *whi, ap_fixed<16, 4, AP_RND, AP_SAT> *who, ap_fixed<16, 4, AP_RND, AP_SAT> *bf, ap_fixed<16, 4, AP_RND, AP_SAT> *bg, ap_fixed<16, 4, AP_RND, AP_SAT> *bi, ap_fixed<16, 4, AP_RND, AP_SAT> *bo)
	...
	void predicts(ap_fixed<16, 4, AP_RND, AP_SAT> *x, ap_fixed<16, 4, AP_RND, AP_SAT> *y, ap_fixed<16, 4, AP_RND, AP_SAT> *wxf, ap_fixed<16, 4, AP_RND, AP_SAT> *wxg, ap_fixed<16, 4, AP_RND, AP_SAT> *wxi, ap_fixed<16, 4, AP_RND, AP_SAT> *wxo, ap_fixed<16, 4, AP_RND, AP_SAT> *whf, ap_fixed<16, 4, AP_RND, AP_SAT> *whg, ap_fixed<16, 4, AP_RND, AP_SAT> *whi, ap_fixed<16, 4, AP_RND, AP_SAT> *who, ap_fixed<16, 4, AP_RND, AP_SAT> *bf, ap_fixed<16, 4, AP_RND, AP_SAT> *bg, ap_fixed<16, 4, AP_RND, AP_SAT> *bi, ap_fixed<16, 4, AP_RND, AP_SAT> *bo)
	...
	//{
		...
		for (int t = 0; t < 75; t++)
		{
			...
			lstm2[t].forward(flag, t, x, y, h_next, c_next, wxf, wxg, wxi, wxo, whf, whg, whi, who, bf, bg, bi, bo);
	...
	void gradients(ap_fixed<16, 4, AP_RND, AP_SAT> *dout, ap_fixed<16, 4, AP_RND, AP_SAT> *wxf, ap_fixed<16, 4, AP_RND, AP_SAT> *wxg, ap_fixed<16, 4, AP_RND, AP_SAT> *wxi, ap_fixed<16, 4, AP_RND, AP_SAT> *wxo, ap_fixed<16, 4, AP_RND, AP_SAT> *whf, ap_fixed<16, 4, AP_RND, AP_SAT> *whg, ap_fixed<16, 4, AP_RND, AP_SAT> *whi, ap_fixed<16, 4, AP_RND, AP_SAT> *who,  ap_fixed<16, 4, AP_RND, AP_SAT> *bf, ap_fixed<16, 4, AP_RND, AP_SAT> *bg, ap_fixed<16, 4, AP_RND, AP_SAT> *bi, ap_fixed<16, 4, AP_RND, AP_SAT> *bo)
	{
		//e.backward(dout, wxf, wxg, wxi, wxo, whf, whg, whi, who, gradswxf, gradswxg, gradswxi, gradswxo, gradswhf, gradswhg, gradswhi, gradswho, gradsbf, gradsbg, gradsbi, gradsbo, wxf2, wxg2, wxi2, wxo2, whf2, whg2, whi2, who2, gradswxf2, gradswxg2, gradswxi2, gradswxo2, gradswhf2, gradswhg2, gradswhi2, gradswho2, gradsbf2, gradsbg2, gradsbi2, gradsbo2); // BiLSTM
		...
		*/
		...
		loops:for(int t = 0; t < 75; t++)
		{
			...
			lstm2[75-t-1].backward(flag, t, dout, dh, hs, dc, wxf, wxg, wxi, wxo, whf, whg, whi, who, gradswxf2, gradswxg2, gradswxi2, gradswxo2, gradswhf2, gradswhg2, gradswhi2, gradswho2, gradsbf2, gradsbg2, gradsbi2, gradsbo2);

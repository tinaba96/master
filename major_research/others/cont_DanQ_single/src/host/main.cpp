	...
	for(int ep = 0; ep < epochs; ++ep)
	{
		...
		//{
			...
			*l = 0;
			...
			OCL_CHECK(err, err = q_backward.enqueueMigrateMemObjects({buffer_output, wxf, wxg, wxi, wxo, whf, whg, whi, who, wxf2, wxg2, wxi2, wxo2, whf2, whg2, whi2, who2, h_wxf, h_wxg, h_wxi, h_wxo, h_whf, h_whg, h_whi, h_who, h_wxf2, h_wxg2, h_wxi2, h_wxo2, h_whf2, h_whg2, h_whi2, h_who2}, CL_MIGRATE_MEM_OBJECT_HOST));

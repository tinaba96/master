...
public: 
	...
	//{
		...
		loopf:for(int t = 0; t < 75; t++)
		{
			...
			//hs+dh=dout
			lstm[75-t-1].backward(74-t, dout, lstm[75-t].dh, hs, dc, wxf, wxg, wxi, wxo, whf, whg, whi, who, gradswxf, gradswxg, gradswxi, gradswxo, gradswhf, gradswhg, gradswhi, gradswho, gradsbf, gradsbg, gradsbi, gradsbo);
		...
		{
			loopim2:for(int s = 0; s < 320; s++)
			{
				//hsdh[s] = hs[(2*(74-t)+1)*320+s] + dh[s];
			}

			//hs+dh=dout
			lstm2[75-t-1].backward(t, dout, lstm2[75-t].dh, hs, dc, wxf2, wxg2, wxi2, wxo2, whf2, whg2, whi2, who2, gradswxf2, gradswxg2, gradswxi2, gradswxo2, gradswhf2, gradswhg2, gradswhi2, gradswho2, gradsbf2, gradsbg2, gradsbi2, gradsbo2);

...
localparam
    ...
    ADDR_IER          = 6'h08,
    ADDR_ISR          = 6'h0c,
    ADDR_DATAX_DATA_0 = 6'h10,
    ADDR_DATAX_DATA_1 = 6'h14,
    ADDR_DATAX_CTRL   = 6'h18,
    ADDR_DATAY_DATA_0 = 6'h1c,
    ADDR_DATAY_DATA_1 = 6'h20,
    ADDR_DATAY_CTRL   = 6'h24,
    ADDR_DOUT_DATA_0  = 6'h28,
    ADDR_DOUT_DATA_1  = 6'h2c,
    ADDR_DOUT_CTRL    = 6'h30,
    ADDR_MODEL_DATA_0 = 6'h34,
    ADDR_MODEL_CTRL   = 6'h38,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,

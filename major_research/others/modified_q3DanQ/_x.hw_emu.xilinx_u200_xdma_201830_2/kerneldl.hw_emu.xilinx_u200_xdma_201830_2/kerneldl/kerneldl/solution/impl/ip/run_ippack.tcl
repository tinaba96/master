...
set IPName      "kerneldl"
set Version     "1.0"
set DisplayName "Kerneldl"
set Revision    "2010231108"
set Description "An IP generated by Vivado HLS"
set Device      "virtexuplus"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set target_part "xcu200-fsgd2104-2-e"
set target_lang "verilog"
set has_xpm_memory "0"
set sdx_kernel_name "kerneldl"
set sdx_kernel_type "hls"
set sdx_kernel_files {/home/inaba/alveo/DanQ_fhalf/src/kernel/kernel.cpp}
set enable_xo_gen 1
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/inaba/alveo/DanQ_fhalf/_x.hw_emu.xilinx_u200_xdma_201830_2/kerneldl.hw_emu.xilinx_u200_xdma_201830_2/kerneldl/kerneldl/solution"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {kerneldl_backward_tempp
...
## Variables
set Top "kerneldl_kerneldl"
set TopNoPrefix "kerneldl"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 datax_1 W 0x0 "Data signal of datax" {{0 32 datax W 0 "Bit 31 to 0 Data signal of datax"}}} {0x14 datax_2 W 0x0 "Data signal of datax" {{0 32 datax W 0 "Bit 63 to 32 Data signal of datax"}}} {0x1c datay_1 W 0x0 "Data signal of datay" {{0 32 datay W 0 "Bit 31 to 0 Data signal of datay"}}} {0x20 datay_2 W 0x0 "Data signal of datay" {{0 32 datay W 0 "Bit 63 to 32 Data signal of datay"}}} {0x28 dout_1 W 0x0 "Data signal of dout" {{0 32 dout W 0 "Bit 31 to 0 Data signal of dout"}}} {0x2c dout_2 W 0x0 "Data signal of dout" {{0 32 dout W 0 "Bit 63 to 32 Data signal of dout"}}} {0x34 model W 0x0 "Data signal of model" {{0 32 model W 0 "Bit 31 to 0 Data signal of model"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.333 machine 64 combinational 0 latency 345285 II x}

...
architecture behave of kerneldl_kerneldl_control_s_axi is
    ...
    constant ADDR_DATAX_DATA_0 : INTEGER := 16#10#;
    constant ADDR_DATAX_DATA_1 : INTEGER := 16#14#;
    constant ADDR_DATAX_CTRL   : INTEGER := 16#18#;
    constant ADDR_DATAY_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_DATAY_DATA_1 : INTEGER := 16#20#;
    constant ADDR_DATAY_CTRL   : INTEGER := 16#24#;
    constant ADDR_DOUT_DATA_0  : INTEGER := 16#28#;
    constant ADDR_DOUT_DATA_1  : INTEGER := 16#2c#;
    constant ADDR_DOUT_CTRL    : INTEGER := 16#30#;
    constant ADDR_MODEL_DATA_0 : INTEGER := 16#34#;
    constant ADDR_MODEL_CTRL   : INTEGER := 16#38#;

...
public:
	...
	void update(ap_fixed<16, 4, AP_RND, AP_SAT>* params, ap_fixed<16, 4, AP_RND, AP_SAT>* grads, ap_fixed<16, 4, AP_RND, AP_SAT>* h, int size)
	{
		...
		for(int i = 0; i < size; ++i)
		{
			...
			//ap_fixed<8, 2, AP_RND, AP_SAT> temp;
			float ftemp;	
			ftemp = h[i];
			temp = sqrt(ftemp);
			temp3 = params[i];
	...
	void updateb(ap_fixed<16, 4, AP_RND, AP_SAT>* params, ap_fixed<16, 4, AP_RND, AP_SAT>* grads, ap_fixed<16, 4, AP_RND, AP_SAT>* h, int size)
	{
